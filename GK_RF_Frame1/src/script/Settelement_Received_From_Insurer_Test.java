...
public class Settelement_Received_From_Insurer_Test extends BaseTest
{
	@BeforeMethod
  ...
  @Test(priority=11,groups={"Settlement_Management","smoke"})
  public void Received_From_Insurer() throws InterruptedException, AWTException 
  {
