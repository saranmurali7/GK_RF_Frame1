...
public class Claim_Approve_INOPS_CHK_Test extends BaseTest
{
	@BeforeMethod
	public void Login() throws InterruptedException 
	{
	 String un=Excel_Data.getValue(EXCEL_PATH,"Valid Login",4,0);
	 String pw=Excel_Data.getValue(EXCEL_PATH,"Valid Login",4,1);
  ...
  @Test(priority=7,groups={"Claim_Management","smoke"})
  public void Claim_Approve_INOPSCHK() throws InterruptedException 
  {
