...
public class Settlement_Insurance_Maker_Approve_Test extends BaseTest
{
	@BeforeMethod
  ...
  @Test(priority=8,groups={"Settlement_Management","smoke"})
  public void Insurance_Maker_Approve() throws InterruptedException, AWTException 
  {
